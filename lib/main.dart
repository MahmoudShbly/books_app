...
import 'package:books_app/features/home/presentation/manager/feature%20books%20cubit/cubit/feature_books_cubit.dart';
...
class BooksApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context)=> FeatureBooksCubit(getIt.get<HomeRepoImpl>())..fetchFeatureBooks()),
